...
UCLASS()
class GASINTRO_API AGASCharacter : public ACharacter, public IAbilitySystemInterface
{
	GENERATED_BODY()
...
public:
	...
	virtual void OnBaseAttackDamageChangedNative(const FOnAttributeChangeData& Data);
	
	virtual void OnSpeedMultiplierChangedNative(const FOnAttributeChangeData& Data);
